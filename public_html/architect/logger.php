...
if (!defined("IN_ADMIN")) { echo "<p style=\"text-align: center; color: red; font-weight: bold;\">".
                               "Помилка входу в модуль logger.php</p>"; require $path."/footer.php"; exit(); }
function logData($userId, $userRole, $changeId, $description) { global $conn;
	$logger_query = "
insert into architect_log(dateIns, ipAddress, userId, userRole, changeId, changeDescription) 
